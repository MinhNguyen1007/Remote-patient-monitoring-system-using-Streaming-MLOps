...
Chạy: python -m rpm_ml.evaluation.report  (cần MLflow server như training/train_risk.py)
"""
...
from rpm_ml.paths import HOURLY_FILE, REPORTS_DIR
from rpm_ml.evaluation.gate import TAU_ANOMALY
from rpm_ml.evaluation.injection import channel_sigma, inject_anomalies
from rpm_ml.evaluation.metrics import CLASSES, anomaly_metrics, classification_metrics
...
from rpm_ml.training.train_risk import EXPERIMENT as RISK_EXPERIMENT
from rpm_ml.training.train_risk import FEATURES, REGISTERED_MODEL as RISK_MODEL, load_splits
from rpm_ml.training.train_anomaly import REGISTERED_MODEL as ANOMALY_MODEL, normal_windows_by_split
