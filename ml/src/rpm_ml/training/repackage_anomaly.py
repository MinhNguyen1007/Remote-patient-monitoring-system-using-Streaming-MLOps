...
Dùng khi code wrapper (`rpm_ml/models/anomaly.py`, được chụp kèm model qua `code_paths`) cần sửa mà model không đổi —
...
Không huấn luyện lại, không chọn lại ngưỡng. Chạy: python -m rpm_ml.training.repackage_anomaly --version 2
"""
...
from rpm_ml.evaluation.gate import TAU_ANOMALY, evaluate_anomaly_gate
...
from rpm_ml.training.train_anomaly import (
    DEFAULT_DATA,
    EXPERIMENT,
    REGISTERED_MODEL,
    evaluate_champion,
