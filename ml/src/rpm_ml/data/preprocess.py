...
Chạy (sau khi `pip install -e packages/common -e ml`): python -m rpm_ml.data.preprocess
...
from rpm_ml.paths import PROCESSED_DIR, RAW_DATA_DIR, SPLIT_FILE
from rpm_ml.data.split import load_or_create_split, subject_to_group

DEFAULT_DATA_DIR = RAW_DATA_DIR
DEFAULT_OUT_DIR = PROCESSED_DIR
DEFAULT_SPLIT_FILE = SPLIT_FILE
HORIZONS = (1, 4)
