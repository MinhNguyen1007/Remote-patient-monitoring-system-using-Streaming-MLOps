...
Chạy từ gốc repo (host): KAFKA_BOOTSTRAP_SERVERS=localhost:29092 .venv\\Scripts\\python streaming/src/producer.py
"""
...
from config import DEFAULT_REPLAY_FILE, load_settings
from kafka_topics import ensure_topics
from messages import VitalsMessage
